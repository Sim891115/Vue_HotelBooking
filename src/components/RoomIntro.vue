<template>
  ...
  <section class="hero">
    <div class="hero-inner">
      <div class="hero-badge">精緻客房｜高隱私｜舒適睡眠</div>
      <h1>客房介紹</h1>
      <p>
        我們設計舒適與高隱私性的客房，提供完善備品與貼心服務，讓您在旅途中也能安心放鬆。
      </p>
    </div>
  </section>
  ...
  <div class="page-container">
    <div class="section-head">
      <h2 class="room-section-title">客房（4）</h2>
      <p class="section-note">價格為參考示意；實際以訂房頁為準。</p>
    </div>
    ...
    <div class="room-list">
      ...
      <Dialog v-model:visible="infoVisible" header="房型介紹｜豪華雙人房" :style="{ width: '92vw', maxWidth: '1100px' }"
        ...
        <div class="roomDialog">
          ...
          <!-- 房內設備 -->
          <div class="section">
            <h3 class="section-title">房間內設備</h3>
            <ul class="list">
              <li>55 吋智慧電視（含有線/串流）</li>
              <li>高速 Wi-Fi、書桌與閱讀燈</li>
              <li>空調、衣櫥、保險箱</li>
              <li>冰箱／迷你吧（依方案）</li>
              <li>快煮壺、茶包/咖啡包、瓶裝水</li>
              <li>吹風機、拖鞋、浴袍（依房型）</li>
            </ul>
          </div>
          ...
          <div class="section">
            ...
            <p class="note">
              若你要「一定有浴缸」，建議在訂房備註註明「需浴缸房」，將依當日房況安排。
            </p>
          </div>
            ...
            <div class="roomDialog">
              ...
              <div class="section">
                ...
                <ul class="list">
                  ...
                  <li>高速 Wi-Fi、獨立空調</li>
                  <li>衣櫥、保險箱</li>
                  <li>冰箱、快煮壺、茶包/咖啡包、瓶裝水</li>
                  <li>吹風機、拖鞋（備品依飯店政策）</li>
                </ul>
              </div>
          ...
          <Dialog v-model:visible="deluxeVisible" header="房型介紹｜豪華雙人房" :style="{ width: '92vw', maxWidth: '1100px' }"
            ...
            <div class="roomDialog">
              ...
              <div class="section">
                <h3 class="section-title">房間內設備</h3>
                <ul class="list">
                  <li>55 吋智慧電視、書桌與閱讀燈</li>
                  <li>高速 Wi-Fi、獨立空調</li>
                  <li>衣櫥、保險箱、行李置放區</li>
                  <li>冰箱、快煮壺、茶包/咖啡包、瓶裝水</li>
                  <li>可提供嬰兒床/護欄（需預先確認）</li>
                </ul>
              </div>
      ...
      <div class="room-card">
        <div class="room-photo">
          <span class="room-tag">尊榮頂級</span>
          <img src="../assets/President.jpg" alt="總統套房" />
          <div class="room-overlay">
            <div class="overlay-left">
              <strong>總統套房</strong>
              每晚 NT$ 12,800 起
        ...
        <div class="room-info">
          <div class="room-title-row">
            <h3>總統套房</h3>
            <span class="room-price">NT$ 12,800 起</span>
          </div>
          ...
          <Dialog v-model:visible="presidentVisible" header="房型介紹｜總統套房" :style="{ width: '92vw', maxWidth: '1100px' }"
            ...
            <div class="roomDialog">
              ...
              <div class="section">
                <h3 class="section-title">房間內設備</h3>
                <ul class="list">
                  <li>獨立客廳與招待空間、用餐/會談區</li>
                  <li>大尺寸智慧電視、音響設備（依房型）</li>
                  <li>高速 Wi-Fi、書桌、專用收納與衣帽間</li>
                  <li>迷你吧、咖啡機/快煮壺（依方案）</li>
                  <li>專屬禮賓與客製化服務（依政策）</li>
                </ul>
              </div>
...
.room-overlay .overlay-left {
  color: rgba(255, 255, 255, 0.92);
  font-size: 13px;
  line-height: 1.4;
}

.room-overlay .overlay-left strong {
  display: block;
  font-size: 16px;
  letter-spacing: 0.5px;
}

.room-overlay .overlay-btn {
  text-decoration: none;
  background: rgba(199, 163, 106, 0.92);
  color: #111;
  font-weight: 800;
  padding: 10px 12px;
  border-radius: 12px;
...
.room-overlay .overlay-btn:hover {
...
.room-actions a.primary {
  border-color: rgba(184, 154, 95, 0.6);
  background: rgba(18, 18, 18, 0.85);
  color: rgba(184, 154, 95, 0.9);
}

/* Vue SFC <style scoped> 內可用 */
:deep(.InfoButton.p-button) {
  background: rgba(20, 20, 20, 0.9);
  border: 1px solid rgba(212, 175, 55, 0.75);
  color: rgba(212, 175, 55, 0.95);
}

:deep(.InfoButton.p-button:not(.p-disabled):hover) {
